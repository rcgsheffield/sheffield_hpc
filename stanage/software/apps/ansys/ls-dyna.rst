...
While using Flight Desktop and TigerVNC, an interactive session can be started on Stanage as linked above. You can load an ANSYS module above and then 
...
Sample LS-DYNA Batch Job Script
""""""""""""""""""""""""""""""""""""
