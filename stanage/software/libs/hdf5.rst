...
.. tabs::
   ...
   .. group-tab:: icelake
         ...
         .. code-block:: console
            ...
            module load 1.14.0-gompi-2022b
            module load 1.13.3-gompi-2022a
            module load 1.12.2-gompi-2022a
            module load 1.12.1-gompi-2021b
            module load 1.10.7-gompi-2021a
            module load 1.10.7-gompi-2020b
            module load 1.10.6-iimpi-2020a
            module load 1.10.6-gompi-2020a
