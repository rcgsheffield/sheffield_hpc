...
For those wanting to learn new skills (such as source control with git), we encourage you to explore our :ref:`upcoming training sessions <training>` . The training team will run courses in data science, machine learning, high-performance computing, and programming, all organized by IT Services and the RSE team.
