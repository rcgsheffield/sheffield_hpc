...
If there are no preconfiguration steps available to generate a suitable **makefile** based on the current shell environment after loading modules or an example **makefile** for editing is provided, 
