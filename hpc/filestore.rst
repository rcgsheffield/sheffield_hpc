...
.. raw:: html
  ...
  <!--The above diagram is loaded via diagrams.net / drawio's javascript and the above HTML exported from their webGUI editor. It can be loaded, edited and exported as HTML using the raw XML file stored in the same folder as this file and their webGUI. -->
  <!--This currently uses their remote JS hosted at diagrams.net but I saved a copy in the repo at _static/js/viewer-static.min.js in case service is ever withdrawn. -->
